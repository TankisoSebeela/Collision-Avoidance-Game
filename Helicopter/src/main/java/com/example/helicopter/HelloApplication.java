...
public class HelloApplication extends Application {
    ...
    Duration dur_1 = Duration.millis(19000);
    Duration dur_2 = Duration.millis(15000);
    Duration dur_3 = Duration.millis(20000);
    Duration dur_4 = Duration.millis(12000);
    Duration dur_5 = Duration.millis(17000);
    ...
    public void Play(){
        seq1.play();seq2.play();seq3.play();seq4.play();seqT1.play();
        seqT2.play();seqT2.play();seqT3.play();seqT4.play();seqT5.play();
    }
    public void Pause(){
        seq1.pause();seq2.pause();seq3.pause();seq4.pause();seqT1.pause();seqT2.pause();
        seqT2.pause();seqT3.pause();seqT4.pause();seqT5.pause();
    }
    ...
    private Label createInstructions() {
        ...
        instructions.setFont(Font.font("Bradley Hand ITC", FontWeight.BOLD,50));
    ...
    private Label createScore() {
        ...
        labelScore.setFont(Font.font("Arial", FontWeight.BOLD,30));
        ...
        shape_1.translateXProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observableValue, Number number, Number t1) {
                if (shape1.getBoundsInParent().intersects(shape_1.getBoundsInParent())){
                    ...
                    Scene game_over_scene = new Scene(gameover());
                    ...
                    score+=1;
                    labelScore.setText("Score is "+score+" ");
                }
    ...
    private VBox gameover() {
        Label score = new Label("Score is "+labelScore.getText());
        Label gameover_label = new Label(" You hit the clouds" +"\n" +"Game over. Press ok to exit");
        ...
        VBox over = new VBox();
        over.getChildren().addAll(gameover_label,score, exit);
